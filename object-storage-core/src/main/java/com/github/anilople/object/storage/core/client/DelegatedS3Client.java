...
import software.amazon.awssdk.services.s3.model.AbortMultipartUploadRequest.Builder;
...
public class DelegatedS3Client implements S3Client {
  ...
  public DelegatedS3Client(S3Client delegate) {
  ...
  @Override
  public AbortMultipartUploadResponse abortMultipartUpload(
      Consumer<Builder> abortMultipartUploadRequest)
      throws NoSuchUploadException, AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.abortMultipartUpload(abortMultipartUploadRequest);
  }
  ...
  public DeleteBucketResponse deleteBucket(
      Consumer<DeleteBucketRequest.Builder> deleteBucketRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.deleteBucket(deleteBucketRequest);
  }
  ...
  @Override
  public DeleteBucketCorsResponse deleteBucketCors(
  ...
  @Override
  public DeleteBucketWebsiteResponse deleteBucketWebsite(
  ...
  @Override
  public DeleteObjectTaggingResponse deleteObjectTagging(
  ...
  @Override
  public GetBucketAclResponse getBucketAcl(
      Consumer<GetBucketAclRequest.Builder> getBucketAclRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.getBucketAcl(getBucketAclRequest);
  }
  ...
  public GetBucketCorsResponse getBucketCors(
      Consumer<GetBucketCorsRequest.Builder> getBucketCorsRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.getBucketCors(getBucketCorsRequest);
  }
  ...
  @Override
  public GetBucketPolicyStatusResponse getBucketPolicyStatus(
  ...
  @Override
  public GetBucketTaggingResponse getBucketTagging(
  ...
  @Override
  public GetObjectAclResponse getObjectAcl(
      Consumer<GetObjectAclRequest.Builder> getObjectAclRequest)
      throws NoSuchKeyException, AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.getObjectAcl(getObjectAclRequest);
  }
  ...
  @Override
  public ResponseInputStream<GetObjectTorrentResponse> getObjectTorrent(
      GetObjectTorrentRequest getObjectTorrentRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.getObjectTorrent(getObjectTorrentRequest);
  }
  ...
  public ResponseBytes<GetObjectTorrentResponse> getObjectTorrentAsBytes(
      GetObjectTorrentRequest getObjectTorrentRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.getObjectTorrentAsBytes(getObjectTorrentRequest);
  }
  ...
  @Override
  public GetPublicAccessBlockResponse getPublicAccessBlock(
  ...
  public ListMultipartUploadsIterable listMultipartUploadsPaginator(
      ListMultipartUploadsRequest listMultipartUploadsRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.listMultipartUploadsPaginator(listMultipartUploadsRequest);
  }
  ...
  @Override
  public ListObjectVersionsIterable listObjectVersionsPaginator(
      ListObjectVersionsRequest listObjectVersionsRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.listObjectVersionsPaginator(listObjectVersionsRequest);
  }
  ...
  public ListObjectsV2Iterable listObjectsV2Paginator(ListObjectsV2Request listObjectsV2Request)
      throws NoSuchBucketException, AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.listObjectsV2Paginator(listObjectsV2Request);
  }

  @Override
  public ListObjectsV2Iterable listObjectsV2Paginator(
      Consumer<ListObjectsV2Request.Builder> listObjectsV2Request)
      throws NoSuchBucketException, AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.listObjectsV2Paginator(listObjectsV2Request);
  }
  ...
  @Override
  public ListPartsResponse listParts(Consumer<ListPartsRequest.Builder> listPartsRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.listParts(listPartsRequest);
  }

  @Override
  public ListPartsIterable listPartsPaginator(ListPartsRequest listPartsRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.listPartsPaginator(listPartsRequest);
  }
  ...
  @Override
  public PutBucketAclResponse putBucketAcl(
      Consumer<PutBucketAclRequest.Builder> putBucketAclRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.putBucketAcl(putBucketAclRequest);
  }
  ...
  @Override
  public PutBucketCorsResponse putBucketCors(
      Consumer<PutBucketCorsRequest.Builder> putBucketCorsRequest)
      throws AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.putBucketCors(putBucketCorsRequest);
  }
  ...
  @Override
  public PutBucketLoggingResponse putBucketLogging(
  ...
  @Override
  public PutBucketPolicyResponse putBucketPolicy(
  ...
  @Override
  public PutBucketReplicationResponse putBucketReplication(
  ...
  @Override
  public PutBucketWebsiteResponse putBucketWebsite(
  ...
  @Override
  public PutObjectAclResponse putObjectAcl(
      Consumer<PutObjectAclRequest.Builder> putObjectAclRequest)
      throws NoSuchKeyException, AwsServiceException, SdkClientException, S3Exception {
    return this.delegate.putObjectAcl(putObjectAclRequest);
  }
  ...
  @Override
  public PutPublicAccessBlockResponse putPublicAccessBlock(
  ...
  @Override
  public UploadPartResponse uploadPart(UploadPartRequest uploadPartRequest, Path sourcePath)
      throws AwsServiceException, SdkClientException, S3Exception {
